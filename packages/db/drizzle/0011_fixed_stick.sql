...
ALTER TABLE "tenant_admin_nominations" ADD CONSTRAINT "tenant_admin_nominations_claimed_user_fk" FOREIGN KEY ("claimed_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "users" ADD CONSTRAINT "users_tenant_id_external_id_unique" UNIQUE("tenant_id","external_id");
